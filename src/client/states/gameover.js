...
GameOver.prototype = {
  init: function(winner, playerCount) {
    ...
    this.winnerText = game.make.text(game.world.centerX, 300, 'The winner is: (insert player number or sprite name here)', {
      font: '40px Mario',
      align: 'center',
      fill: 'red'
    });
  ...
  restartGame: function () {
    var text = game.add.text(game.world.centerX, game.world.height * 0.8, 'Rematch?', {
      font: '40px Mario',
      align: 'center',
      fill: 'red'
    });
